...
@element_router.get("/", response=List[ElementOut], tags=["Elements"])
...
@element_router.put("/{element_id}", response=ElementOut, tags=["Elements"])
...
@element_router.delete("/{element_id}", tags=["Elements"])
