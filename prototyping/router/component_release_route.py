...
@component_release_router.post("/", response={201: ComponentReleaseSchema}, auth=[QueryTokenAuth(), HeaderTokenAuth()])
...
@component_release_router.get("/", response=List[ComponentReleaseSchema], auth=[QueryTokenAuth(), HeaderTokenAuth()])
...
@component_release_router.put("/{component_release_id}", response=ComponentReleaseSchema, auth=[QueryTokenAuth(), HeaderTokenAuth()])
...
@component_release_router.delete("/{component_release_id}", response={204: None}, auth=[QueryTokenAuth(), HeaderTokenAuth()])
